...
const ExampleArt = ({ backgroundColor, color1, color2, color3, color4 }) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 14 18" shapeRendering="crispEdges">
        ...
        <rect y="16.5" width="100%" height="2" fill={color4} />
      </svg>
